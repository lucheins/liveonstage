function Controller() {
    ...
    $.__views.Navigation.add($.__views.__alloyId64);
    ...
    $.__views.categories.add($.__views.__alloyId65);
    ...
    $.__views.categories.add($.__views.__alloyId66);
    ...
    $.__views.videos.add($.__views.__alloyId67);
    ...
    $.__views.videos.add($.__views.__alloyId68);
    ...
    $.__views.campaigns.add($.__views.__alloyId69);
    ...
    $.__views.campaigns.add($.__views.__alloyId70);
    ...
    $.__views.upcoming.add($.__views.__alloyId71);
    ...
    $.__views.upcoming.add($.__views.__alloyId72);
    ...
    $.__views.artists.add($.__views.__alloyId73);
    ...
    $.__views.topNav.add($.__views.__alloyId74);
    var __alloyId75 = [];
    $.__views.categoriesScreen = Ti.UI.createView({
        id: "categoriesScreen"
    });
    __alloyId75.push($.__views.categoriesScreen);
    ...
    __alloyId75.push($.__views.videosScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId75.push($.__views.campaignsScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId75.push($.__views.upcomingScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId75.push($.__views.artistsScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
