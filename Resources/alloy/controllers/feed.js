function Controller() {
    ...
    $.__views.Navigation.add($.__views.__alloyId17);
    ...
    $.__views.categories.add($.__views.__alloyId18);
    ...
    $.__views.videos.add($.__views.__alloyId20);
    ...
    $.__views.campaigns.add($.__views.__alloyId22);
    ...
    $.__views.upcoming.add($.__views.__alloyId24);
    ...
    $.__views.artists.add($.__views.__alloyId26);
    ...
    $.__views.topNav.add($.__views.__alloyId27);
    var __alloyId28 = [];
    $.__views.categoriesScreen = Ti.UI.createView({
        id: "categoriesScreen"
    });
    __alloyId28.push($.__views.categoriesScreen);
    ...
    __alloyId28.push($.__views.videosScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId28.push($.__views.campaignsScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId28.push($.__views.upcomingScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId28.push($.__views.artistsScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
